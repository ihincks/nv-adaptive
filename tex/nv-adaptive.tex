...
coefficients is the parameter of interest.
The methods that we use are generic and can be adapted to any quantum device.
\end{abstract}
...
relevant inference parameters (we ultimately use 10, including nuissance
...
Heuristics were compared by running each 100 independent times, and comparing
...
heuristics (\subref{fig:heuristic-comparison}{(a-c)}), we found that the
